...
import { TokenServerAuthClient } from "./TokenServerAuthClient";
...
const App: React.FC = () => {
  ...
  const tokenServerAuthClient = useMemo(() => new TokenServerAuthClient(), []);
  ...
  const realityDataAccessClient = useMemo(
    (): RealityDataAccessClient => {
      ...
      const realityDataClientOptions: RealityDataClientOptions = {
        ...
        authorizationClient: tokenServerAuthClient
      };
      return new RealityDataAccessClient(realityDataClientOptions);
    }, [tokenServerAuthClient],
  );
  /*
  ...
  */
  ...
  useEffect(() => {
    const init = async () => {
      await tokenServerAuthClient.initialize();
  ...
  return (
    <div className="App">
      ...
      {accessToken && (
        <ThemeProvider theme="light">
          <TabMenu realityDataAccessClient={realityDataAccessClient} authorizationClient={tokenServerAuthClient} />
        </ThemeProvider>
      )}
    </div>
  );
